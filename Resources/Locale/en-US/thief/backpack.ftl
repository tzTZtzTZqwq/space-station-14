thief-backpack-window-title = 盗贼工具包
...
thief-backpack-window-selected = 已选择装备包: ({$selectedCount}/{$maxCount})

thief-backpack-window-approve-button = 批准
thief-backpack-button-select = 选择 [  ]
thief-backpack-button-deselect = 选择[X]

#设置

thief-backpack-category-chameleon-name = 变色龙套装
...
thief-backpack-category-tools-name = 破门工具包
...
thief-backpack-category-chemistry-name = 解剖学工具包
...
thief-backpack-category-syndie-name = 辛迪套件
...
thief-backpack-category-sleeper-name = 沉睡者套装
...
thief-backpack-category-communicator-name = 通讯器套装
...
thief-backpack-category-smuggler-name = 走私者工具包
